        ...
        <div className="p-6 flex-1 flex flex-col">
          ...
          <div className="mt-auto space-y-4">
            ...
            <button
              ...
              disabled={isDeleting}
              className="w-full group/delete relative px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
            >
